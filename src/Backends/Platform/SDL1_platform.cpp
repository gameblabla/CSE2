		...
		switch (event.type)
		{
			...
			case SDL_KEYDOWN:
				switch (event.key.keysym.sym)
				{
					...
					DO_KEY(SDLK_LSHIFT, BACKEND_KEYBOARD_A)
					
					DO_KEY(SDLK_LCTRL, BACKEND_KEYBOARD_Z)
					DO_KEY(SDLK_LALT, BACKEND_KEYBOARD_X)
					
					DO_KEY(SDLK_TAB, BACKEND_KEYBOARD_A)
					DO_KEY(SDLK_BACKSPACE, BACKEND_KEYBOARD_Z)
					
					DO_KEY(SDLK_RETURN, BACKEND_KEYBOARD_W)
					DO_KEY(SDLK_RCTRL, BACKEND_KEYBOARD_W)
					
					DO_KEY(SDLK_SPACE, BACKEND_KEYBOARD_S)
